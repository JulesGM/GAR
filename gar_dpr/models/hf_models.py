...
class BertTensorizer(Tensorizer):
    ...
    def text_to_tensor(self, text: str, title: str = None, add_special_tokens: bool = True, remove_start_end=False):
        text = text.strip()
        ...
        if title:
            ...
            if remove_start_end:
                # remove special tokens and only keeps the one between seq
